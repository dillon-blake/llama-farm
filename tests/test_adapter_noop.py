...
def test_no_op_holds_with_the_embedding_and_head_adapted(
    ...
    """The no-op property still holds with the embedding and LM head adapted.

    This is what exercises the flipped token_embd convention against the *stock loader*, not
    just against our own reader. If the shapes at src/llama-adapter.cpp:356-360 were written
    wrong, the adapter would not load at all and this test would error rather than fail.
    """
    tokens = [1, 5, 9, 42, 7, 3]
